...
builder.Services.Configure<MellatPaymentSettings>(builder.Configuration.GetSection("MellatPayment"));
...
builder.Services.AddHttpClient<IMellatPaymentService, MellatPaymentService>(client =>
{
